...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.media.c2@1.0-mediatek.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.thermal@2.0-service.mediatek.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/vendor.mediatek.camera.provider.xml
DEVICE_MATRIX_FILE := $(DEVICE_PATH)/compatibility_matrix.xml
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := $(DEVICE_PATH)/framework_compatibility_matrix.xml

-include vendor/oneplus/Dubai/BoardConfigVendor.mk